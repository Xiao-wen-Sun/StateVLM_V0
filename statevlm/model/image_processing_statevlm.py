...
class StateVLMBatchFeature(BatchFeature):
    r"""
    ...
    def to(self, *args, **kwargs) -> "StateVLMBatchFeature":
...
class StateVLMImageProcessor(BaseImageProcessor):
