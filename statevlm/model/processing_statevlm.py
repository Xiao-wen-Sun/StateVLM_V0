...
from .image_processing_statevlm import StateVLMBatchFeature


class StateVLMProcessor(ProcessorMixin):
    r"""
    Constructs a StateVLM processor which wraps a StateVLM image processor and a StateVLM tokenizer into a single processor.

    [`StateVLMProcessor`] offers all the functionalities of [`StateVLMImageProcessor`] and [`LlamaTokenizerWrapper`]. See the
    [`~StateVLMProcessor.__call__`] and [`~StateVLMProcessor.decode`] for more information.

    Args:
        image_processor ([`StateVLMImageProcessor`], *optional*):
    ...
    def _convert_images_texts_to_inputs(
        ...
        if images is None or not len(images):
            ...
            return StateVLMBatchFeature(data={**model_inputs})
        ...
        return StateVLMBatchFeature(data={
